...
class Appointments extends Component {
  ...
  onAddAppointment = event => {
    ...
    const {titleInput, dateInput, descInput} = this.state
  ...
  render() {
    const {titleInput, dateInput, descInput, isFilterActive} = this.state
      ...
      <div className="app-container">
        <div className="responsive-container">
          <div className="appointments-container">
            <h1 className="main-head">TASK TRACKER APP</h1>
            ...
            <div className="header-with-filter-container">
              <h1 className="appointments-heading">Tasks List </h1>
              <button
                type="button"
